...
module.exports = {
  ...
  HANDLERS:
    process.env.HANDLER === "false" || process.env.HANDLER === "null"
      ...
      : "^[.]",
  BRANCH: "master",
  OWNER_NUMBER: ["918891871875@s.whatsapp.net", "0@s.whatsapp.net"],
  STICKER_DATA: process.env.STICKER_DATA || "Nxiii;Nazim",
  SUDO: process.env.SUDO || "918891871875,0",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "Nazim",
  BOT_NAME: process.env.BOT_NAME || "Nxiii",
